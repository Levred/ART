...
# test_PointNommeDelegation START DELETE
...
# exemple START DELETE
def exemple():
	# cr�er les points sommets du triangle
# AVEC_NOMS START DELETE
	p1 = PointNomme("A", 3, 2)
	p2 = PointNomme("S", 6, 9)
